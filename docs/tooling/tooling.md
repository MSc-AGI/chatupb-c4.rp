...
Un workspace de Structurizr puede contener multiples vistas. Aqui un ejemplo de otro proyecto con vistas interactivas:

![Pagina principal de Structurizr mostrando un workspace con multiples vistas de diagrama](images/01-structurizr-workspace-ejemplo.png)

### Vista Default

Structurizr genera automaticamente un diagrama de contexto al cargar un workspace con la definicion DSL.

![Vista default de Structurizr con diagrama System Context - User, Web Application, Database Schema](images/02-structurizr-vista-default.png)
...
![Dialogo de exportacion con las 5 vistas de ChatUPB - opciones Crop, Download, Publish activadas](images/03-structurizr-exportar-diagramas.png)

### Archivos Exportados

Los archivos exportados se descargan al sistema local. Cada vista genera un archivo PNG y SVG.

![Archivos exportados en carpeta de descargas - SystemContext.png, SystemContext-key.png, SystemContext-key.svg](images/04-archivos-exportados.png)
...
![Diagrama C3 completo de ChatUPB en SVG - 17 componentes con flechas de dependencia](images/05-c3-componentes-svg.png)
...
![Pagina principal de Structurizr para ChatUPB con miniaturas de las 5 vistas C4](images/06-structurizr-chatupb-home.png)
...
![README del repositorio en GitHub mostrando diagramas C2 Containers y C3 Components embebidos](images/07-github-readme-diagramas.png)
